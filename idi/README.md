...
| `devkit/` | Builder CLI, manifests, sample configs, and unit tests. |
...
2. Use `python -m idi.devkit.builder --config ... --out ... --install-inputs specs/V38_Minimal_Core/inputs` to produce streams + manifests.
